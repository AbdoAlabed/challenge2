...
function makeComputer(type, color, weight) {
  // TODO: Your code here
  var computers = {};
  return computer = {type: "type", color: "color", weight: "weight"};
}
var computers = [];
computers[0]= makeComputer("Tohiba" , "black", 32); 
computers[1]= makeComputer("dell" , "grey", 30); 
...
for(var i =0 ;i< arrayOfStrings.length ; i++){
   upperCase[i]= arrayOfStrings[i].toUpperCase();
}
 return upperCase;
}
uppercaseAll(["Hello","world","Peas"]);
//=============================================================================
/*                                  Q3                                       */
//=============================================================================
...
function highestPopulation(arrayOfObjects) {
  ...
  for( var i= 0 ; i< arrayOfObjects.length; i++){
  	if(arrayOfObjects[i]["population"] > 500000000){
  		pop[c] = arrayOfObjects[i];
  		c++;
  	}
  } return pop;
}
